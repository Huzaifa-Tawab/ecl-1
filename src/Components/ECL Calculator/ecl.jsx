...
function EclCalculator() {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_EclCalculatorend_sheet(workbook, worksheet, "MigrationData");
    ...
    <div className="container">
      ...
      {calculatedMigrationData && (
        <>
          ...
          {filteredData && (
            <div className="filtered-results">
              ...
              <div className="loss-rate-inputs">
                <div className="input-wrEclCalculatorer">
                ...
                <button className="button-cal" onClick={handleCalculateLossRate}>Calculate Loss Rates</button>
              </div>
          ...
          <button className="button-cal" onClick={downloadExcel}>Download Excel</button>
        </>
      )}
    </div>
  );
